...
//code made in class
// Vanilla JS Task: Using JavaScript, add a descriptive page title.
      var titleTags = document.getElementsByTagName("title");
      var title = titleTags[0]
      title.text = "F2: JS Lessons"
...
//
// You’ll need: document.createElement() and element.appendChild()
      // var proList = document.getElementById("lab-images")
      // proList.createElement("li")
      // proList.element.appendChild() =
      //   <img src="./assets/img/blob.jpg">
      //   <span>Lab 2: Star Trek</span>
      // </li>
...
// picsUl from before
      var newLi = document.createElement("li");
      var newImg = document.createElement("img");
      newImg.setAttribute( "src", "https://upload.wikimedia.org/wikipedia/en/2/2b/TOSopeninglogo.png")
      newLi.appendChild(newImg);
      picsUl.appendChild(newLi);


// Example 5: window.addEventListener("load")

      function welcomeUserToPage () {
        prompt("welcome To F2")
      }
      window.addEventListener("load", welcomeUserToPage)
