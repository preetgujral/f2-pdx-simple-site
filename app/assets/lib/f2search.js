//this works by turning the entire file into a function that the server can access.
...
//start of the actual search functionality​
  var findPhrase = function (phrase) {
//create results object with lectures and labs as properties and values of empty arrays
    var results = {
      lectures: [],
      labs: []
    };
​//and an empty notes array
    var notes = [];
​
//this is where you stopped processing things before class started
